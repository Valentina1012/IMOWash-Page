        ...
        <section className={`${Styles.principal} `}>
            <div id={location.id} className={`${Styles.navigationWrapper} cardLocationWrapper`}> 
                <div className={`${Styles.slideContainr}`}>
                    ...
                    <h3 className={`${Styles.titleUbication}`}>{location.ubication[0].name}</h3>
            ...
            <footer className={`${Styles.footer}`}>
                ...
                <a className={`${Styles.link}`} href={location.ubication[0].map} target='_blank'>Navigate on Google Maps</a>
            </footer>
        </section>
    )
}
